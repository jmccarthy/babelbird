var XpiInstaller = {
	...
	extFullName: 'BabelBird', // The name displayed to the user (don't include the version)
	extShortName: 'babelbird', // The leafname of the JAR file (without the .jar part)
	extVersion: '1.0',
	extAuthor: 'Justin McCarthy',
